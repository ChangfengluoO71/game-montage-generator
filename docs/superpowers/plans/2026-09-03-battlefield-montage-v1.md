...
- Placeholder scan: no step depends on `TODO`, `TBD`, “implement later”, or an unspecified error-handling task. Every step names files, interfaces, commands, and expected outcomes.
